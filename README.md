The program is designed to solve the Sliding Bricks Puzzle using four different search algorithms: Breadth-First Search (BFS), Depth-First Search (DFS), Iterative Deepening
